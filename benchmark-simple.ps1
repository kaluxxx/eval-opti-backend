...
Write-Host "  - benchmark_stats_365.md" -ForegroundColor White
Write-Host "  - benchmark_stats_100.md" -ForegroundColor White
Write-Host "  - benchmark_csv_30.md" -ForegroundColor White
Write-Host "  - benchmark_cache.md" -ForegroundColor White
Write-Host ""
